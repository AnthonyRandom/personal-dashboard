...
const moodData = [
  {
    ...
    entry: "Feeling productive and focused today. Great progress on projects!",
  },
  {
    date: "Yesterday",
    mood: "good",
    ...
    color: "text-blue-500",
    entry:
      "Had a successful meeting with the team. Feeling optimistic about upcoming deadlines.",
  },
  {
    date: "Jan 14",
    mood: "okay",
    ...
    entry:
      "Bit stressed about workload but managed to complete important tasks.",
  },
  {
    date: "Jan 13",
    mood: "good",
    ...
    color: "text-blue-500",
    entry:
      "Great workout session this morning. Feeling energized for the day ahead.",
  },
  {
    date: "Jan 12",
    mood: "amazing",
    ...
    color: "text-red-500",
    entry:
      "Celebrated a major project milestone with the team. Feeling grateful and accomplished.",
  },
];
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Track your daily mood and reflect on your thoughts
          </p>
        </div>
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-sm capitalize ${entry.color}`}>
                      {entry.mood}
                    </span>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 rounded-lg bg-blue-50 border border-blue-200">
            ...
            <p className="text-sm text-blue-700">
              You tend to feel better on days when you exercise in the morning.
              Consider maintaining this routine.
            </p>
          </div>
          ...
          <div className="p-4 rounded-lg bg-green-50 border border-green-200">
            ...
            <p className="text-sm text-green-700">
              You've been journaling for 12 days straight! This consistency is
