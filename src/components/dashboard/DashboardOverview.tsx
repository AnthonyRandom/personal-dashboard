  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 stagger-animation">
        ...
        <div style={{ "--stagger-delay": "5" } as React.CSSProperties} className="md:col-span-2">
          <ProductivityWidget />
        </div>
        ...
        <div style={{ "--stagger-delay": "8" } as React.CSSProperties} className="md:col-span-2 lg:col-span-3">
          <NewsWidget />
        </div>
        ...
        <div style={{ "--stagger-delay": "10" } as React.CSSProperties} className="md:col-span-2">
          <SocialWidget />
        </div>
      </div>
    </div>
